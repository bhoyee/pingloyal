...
// ── Additional tier edge cases ─────────────────────────────────────────────────

describe('TierService — boundary and edge cases', () => {
  let service: TierService;
  ...
  it('T23 — spend below all tier minimums → null tier when no tier matches', async () => {
    const tiersWithGap = [
      { ...MID, minQuarterlySpend: 100_000 },
