        ...
        <div className="grid grid-cols-2 gap-10 md:grid-cols-5">
          ...
          <div>
            ...
            <div className="mt-4 flex items-center gap-3">
              {/* WhatsApp */}
              <a href="https://wa.me/2349094135585" aria-label="WhatsApp" className="text-gray-400 transition-colors hover:text-[#25D366]">
              ...
              {/* Instagram */}
              <a href="https://instagram.com/pingloyal" aria-label="Instagram" className="text-gray-400 transition-colors hover:text-[#E1306C]">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* LinkedIn */}
              <a href="https://linkedin.com/company/pingloyal" aria-label="LinkedIn" className="text-gray-400 transition-colors hover:text-[#0A66C2]">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                </svg>
              </a>
              {/* X / Twitter */}
              <a href="https://x.com/pingloyal" aria-label="X (Twitter)" className="text-gray-400 transition-colors hover:text-white">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.747l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              {/* Facebook */}
              <a href="https://facebook.com/pingloyal" aria-label="Facebook" className="text-gray-400 transition-colors hover:text-[#1877F2]">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* TikTok */}
              <a href="https://tiktok.com/@pingloyal" aria-label="TikTok" className="text-gray-400 transition-colors hover:text-white">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
