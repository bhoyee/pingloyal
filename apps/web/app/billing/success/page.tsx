      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-slate-50 p-8 text-center">
        <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-slate-600">
            Your{' '}
            <span className="font-semibold capitalize">{status.planTier}</span>{' '}
            plan is now active.
          </p>
          <div className="mt-4 space-y-2 rounded-xl bg-slate-50 p-4 text-left text-sm text-slate-600">
            <p>
              📬 Utility messages included:{' '}
              <strong>{status.utilityIncluded}/month</strong>
            </p>
            <p>
              💬 Marketing messages:{' '}
              <strong>
                {currencySymbol}
                {status.marketingRate}/msg
              </strong>{' '}
              from your wallet
            </p>
          </div>
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-slate-50 p-8 text-center">
        <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-slate-600">
            Your account will activate within a few minutes. You will receive a
