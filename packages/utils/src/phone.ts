...
// Each rule: localTotalLength includes the trunk prefix digit(s).
// subscriberLength = localTotalLength - localPrefix.length
...
const COUNTRY_CODE: Record<DefaultCountry, string> = {
  NG: '234',
  GB: '44',
  US: '1',
};
 ...
 */
function fixNgExtraZero(e164: string): string {
...
function ruleFor(country: DefaultCountry): CountryRule {
